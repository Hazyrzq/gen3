        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.testimonials.update', $testimonial)}}"" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        <x-input-label for="meesage" :value="__('meesage')" />
                        <textarea name="meesage" id="meesage" cols="30" rows="5" class="border border-slate-300 rounded-xl w-full">{{$testimonial->meesage}}</textarea>
                        <x-input-error :messages="$errors->get('meesage')" class="mt-2" />
                    </div>
