        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.hero_sections.update', $heroSection)}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        <x-input-label for="achivement" :value="__('achievment')" />
                        <x-text-input id="achievment" class="block mt-1 w-full" type="text" name="achievment"  
                        value="{{$heroSection->achievment}}" required autofocus autocomplete="achievment" />
