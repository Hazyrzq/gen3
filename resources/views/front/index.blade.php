...
<div id="header" class="bg-[#F6F7FA] relative overflow-hidden">
  ...
  <div id="Teams" class="bg-[#F6F7FA] w-full py-20 px-[10px] mt-20">
    ...
    <div class="card bg-white flex flex-col h-full justify-center items-center p-[30px] gap-[30px] rounded-[20px] border border-[#f2e8ef] hover:shadow-[0_10px_30px_0_#D1D4DF80] hover:border-cp-dark-blue transition-all duration-300">
        <div class="w-[200px] h-[200px] flex items-center justify-center overflow-hidden rounded-full">
  ...
  <div id="Awards" class="container max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-20">
    ...
    <div class="awards-card-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[30px] justify-center">
      <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
        ...
        <p class="font-bold text-xl leading-[30px]">Asynchronous Crafting Excellence
        </p>
        <hr class="border-[#E8EAF2]">
        <p class="text-cp-light-grey">Bali, 2024</p>
      </div>
      <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
        <div class="w-[55px] h-[55px] flex shrink-0">
          <img src="{{asset('assets/icons/cup-blue.svg')}}" alt="icon">
        ...
        <hr class="border-[#E8EAF2]">
        <p class="font-bold text-xl leading-[30px]">Harmony in Crowded Spaces</p>
        <hr class="border-[#E8EAF2]">
        <p class="text-cp-light-grey">Shanghai, 2024</p>
      </div>
      <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
        <div class="w-[55px] h-[55px] flex shrink-0">
          <img src="{{asset('assets/icons/cup-blue.svg')}}" alt="icon">
        ...
        <hr class="border-[#E8EAF2]">
        <p class="font-bold text-xl leading-[30px]">Big Impacts from Small Actions</p>
        <hr class="border-[#E8EAF2]">
      ...
      <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
        ...
        <hr class="border-[#E8EAF2]">
        <p class="font-bold text-xl leading-[30px]">Teamwork and Unity</p>
        <hr class="border-[#E8EAF2]">
          ...
          <div class="flex flex-col gap-[30px] sm:w-[603px] shrink-0">
              <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                  ...
                  <div id="accordion-faq-1" class="accordion-content hide">
                      <p class="leading-[30px] text-cp-light-grey pt-[14px]">Yes, offering installments can be highly beneficial for both our clients and us. It allows clients to manage their budget more effectively, making our web development services more accessible. For us, it ensures a steady workflow and fosters long-term relationships with our clients.</p>
                  </div>
              </div>
              <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                  ...
                  <div id="accordion-faq-2" class="accordion-content hide">
                      <p class="leading-[30px] text-cp-light-grey pt-[14px]">We are proficient in a variety of popular frameworks. For front-end development, we frequently use React, Angular, and Vue.js. For back-end development, we excel in Node.js, Django, and Laravel. Our team constantly updates its skills to leverage the best technologies for your projects.</p>
                  </div>
              </div>
              <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                  ...
                  <div id="accordion-faq-3" class="accordion-content hide">
                      <p class="leading-[30px] text-cp-light-grey pt-[14px]">We collaborate with top insurance providers to offer comprehensive coverage for all our web development projects. This ensures that both our team and our clients are protected throughout the development process, providing peace of mind and security.</p>
                  </div>
              </div>
              <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                  ...
                  <div id="accordion-faq-4" class="accordion-content hide">
                      <p class="leading-[30px] text-cp-light-grey pt-[14px]">If you have any other questions, please feel free to reach out to us through our support page or contact our customer service. We are always here to assist you with any inquiries about our web development services, ensuring you have all the information you need.</p>
                  </div>
              </div>
          </div>
      </div>
