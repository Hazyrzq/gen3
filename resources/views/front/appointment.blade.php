    ...
    <div class="flex flex-col mt-20 gap-[50px]">
      ...
      <div class="flex flex-col gap-5">
        <div class="flex items-center gap-[10px]">
          ...
          <p class="text-cp-dark-blue font-semibold">No. 123, Manunggal Bhakti, Jakarta</p>
        </div>
        <div class="flex items-center gap-[10px]">
          <div class="w-6 h-6 flex shrink-0">
            <img src="assets/icons/call.svg" alt="icon">
          </div>
          <p class="text-cp-dark-blue font-semibold">(+62) 85960652905</p>
        </div>
        <div class="flex items-center gap-[10px]">
          <div class="w-6 h-6 flex shrink-0">
            <img src="assets/icons/monitor-mobbile.svg" alt="icon">
          </div>
          <p class="text-cp-dark-blue font-semibold">Gen3.com</p>
        </div>
      </div>
    </div>
